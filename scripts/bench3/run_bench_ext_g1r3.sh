#!/bin/bash
# g1r3 扩展轮：PR@131K + PR@400K × C1/C2/C4/C6 (max output=1)
set -uo pipefail
OUT=/home/_PH_USER_/bench3-results/g1r3-ext
mkdir -p $OUT
...
echo "==== BENCH g1r3-ext start $(date -u) ===="
# C1 先验证单请求可行性（131K）
...
echo "==== BENCH g1r3-ext done $(date -u) ===="
echo "BENCH_g1r3_EXT_DONE"
