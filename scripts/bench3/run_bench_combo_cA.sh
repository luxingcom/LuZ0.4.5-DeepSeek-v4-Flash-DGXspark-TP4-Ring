#!/bin/bash
# LuZ0.3.1 组合 cA 基准：PR4K + PR32K × C1/C4/C8
set -uo pipefail
OUT=/home/_PH_USER_/bench3-results/combo-cA
mkdir -p $OUT
...
echo "==== BENCH combo-cA start $(date -u) ===="
# 全局 warmup
...
echo "==== BENCH combo-cA done $(date -u) ===="
echo "BENCH_COMBO_cA_DONE"
