#!/bin/bash
# luz044 扩展轮：PR@131K + PR@400K × C1/C2/C4/C6 (max output=1)
set -uo pipefail
OUT=/home/_PH_USER_/bench3-results/luz044-ext
mkdir -p $OUT
...
echo "==== BENCH luz044-ext start $(date -u) ===="
# C1 先验证单请求可行性（131K）
...
echo "==== BENCH luz044-ext done $(date -u) ===="
echo "BENCH_luz044_EXT_DONE"
