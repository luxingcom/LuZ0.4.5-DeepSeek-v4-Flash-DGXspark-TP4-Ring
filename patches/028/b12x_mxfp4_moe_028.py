...
# --- W9-R8 port shim: official 0.28.0 vllm.envs lacks fork-custom VLLM_B12X_* attrs ---
import os as _os_w9
class _W9EnvShim:
    _DEFAULTS = {
        "VLLM_B12X_W4A16_FORCE_BLOCKS_PER_SM": "0",
        "VLLM_B12X_W4A16_FORCE_BLOCKS_MAX_M": "0",
        "VLLM_B12X_W4A16_FORCE_TILE_CONFIG": "",
    }
    def __getattr__(self, name):
        if name.startswith("VLLM_B12X"):
            return _os_w9.environ.get(name, self._DEFAULTS.get(name, "0"))
